    ...
    <div class="row margin-home-content">
        <div class="col-md-10">
            ...
            <div class="titulo-home">
                <a href="{{route('home')}}">INICIO</a> > <a href="{{route('home.herramienta')}}">HERRAMIENTA</a> > <a href="{{route('texto-sentencia.index')}}">TEXTO SENTENCIA</a> > VER
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class=" col-md-4">
                            <a href="{{route('texto-sentencia.index')}}" class="btn btn-secondary btn-block generate-sentencia" style="padding-left: 1rem; padding-right: 1rem;">Volver<i class="material-icons"></i></a>
                        </div>
                        <div class=" col-md-4">
                            <a href="{{route('texto-sentencia.edit', $texto_sentencia)}}" class="btn btn-secondary btn-block generate-sentencia" style="padding-left: 1rem; padding-right: 1rem;">Editar<i class="material-icons"></i></a>
                        </div>
                        <div class=" col-md-4">
